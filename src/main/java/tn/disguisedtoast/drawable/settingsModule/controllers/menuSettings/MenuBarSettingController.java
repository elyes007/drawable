...
public class MenuBarSettingController implements Initializable, SettingsControllerInterface {

    private final CSSWriter aWriter = new CSSWriter(new CSSWriterSettings(ECSSVersion.CSS30, false));
    @FXML
    public ComboBox toolbarTheme;
    @FXML
    public TextField titleText;
    @FXML
    public ToggleButton titleBold;
    @FXML
    public ToggleButton titleItalic;
    @FXML
    public ToggleButton titleUnderlined;
    @FXML
    public ComboBox titleSize;
    @FXML
    public Label titleFontColorPane;
    ...
    public void setMenuBarElement(GeneratedElement element) {
