...
public class TestShapeParsing {
    public static void main(String[] args) throws NoDetectedObjects, NoFramesDetected, FailedToCreateHtmlFromIonApp {
        ...
        objects.add(new DetectedObject(DetectedObject.FRAME, new Box(0, 11, 10, 2)));

        CodeGenerator.parse(objects);
    }
}
